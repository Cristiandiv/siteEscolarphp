...
<?php
	...
	$res = mysqli_query($con,"select * from tb_loginProf where senha='$senha' or email='$email'");  
...
{
    echo "<a href='aluno/indexA.php'><input type='submit' value='Ir'></a>";
}
else
{
...
?>
	...
	<center>
	<form action="loginProf.php" method="GET">
	<fieldset>
	<table>
		<tr><h1>Login do Professor</h1></tr>
	  <tr>
	   <td> Usuário: </td>
